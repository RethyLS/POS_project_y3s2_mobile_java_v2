...
public class ApiClient {
    private static final String BASE_URL = "http://192.168.1.165:8000/api/"; // Using local network IP
    public static final String IMAGE_BASE_URL = "http://192.168.1.165:8000/api/storage/"; // For image serving
    ...
    public static String fixImageUrl(String originalUrl) {
        ...
        if (originalUrl.contains("0.0.0.0:8000")) {
            return originalUrl.replace("0.0.0.0:8000", "192.168.1.165:8000");
        }
